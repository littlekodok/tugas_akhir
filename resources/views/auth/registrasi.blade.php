...
<head>
   <meta charset="utf-8">
	...
	<!-- PAGE TITLE HERE -->
	<title>Registrasi | E-SPTPD Kabupaten Rembang</title>
...
<div class="page-wraper">
    ...
    <div class="browse-job login-style3">
        <!-- Coming Soon -->
        <div class="bg-img-fix overflow-hidden" style="background-image:url(images/background/bg6.jpg); height: 100vh;">
            <div class="row gx-0">
								...
								<div class="card-body">
										...
										<a href="index.html" class="logo-white">
											<svg class="brand-title" xmlns="http://www.w3.org/2000/svg" width="134.01" height="48.365" viewBox="0 0 134.01 48.365">
											  <g id="Group_38" data-name="Group 38" transform="translate(-133.99 -40.635)">
												<text id="Job_Admin_Dashboard" data-name="Job Admin Dashboard" transform="translate(134 85)" fill="#787878" font-size="12" font-family="Poppins-Light, Poppins" font-weight="300"><tspan x="0" y="0">E-SPTPD Rembang</tspan></text>
									...
									<div class="tab-content w-100" id="t">
									  <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
										<form class="dez-form py-5 needs-validation" novalidate method="post" action="{{ route('post.registrasi') }}">
											...
											<div class="form-group mt-3">
												<input name="email" required class="form-control @error('email') is-invalid @enderror" placeholder="Email Address" type="email" value="{{ old('email') }}">
												@error('email')
														<div class="invalid-feedback">
														{{ $message }}
														</div>
									...
									<div class="card-footer">
										...
										<div class="col-lg-12 text-center">
											<span> E-SPTPD  Kabupaten Rembang<span class="heart"></span>
