...
<head>
   <meta charset="utf-8">
	...
	<!-- PAGE TITLE HERE -->
	<title>Login | E-SPTPD Kabupaten Rembang</title>
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
										...
										<a href="index.html" class="brand-logo">
											...
											<svg class="brand-title" xmlns="http://www.w3.org/2000/svg" width="134.01" height="48.365" viewBox="0 0 134.01 48.365">
											  <g id="Group_38" data-name="Group 38" transform="translate(-133.99 -40.635)">
												<text id="Job_Admin_Dashboard" data-name="Job Admin Dashboard" transform="translate(134 85)" fill="#787878" font-size="12" font-family="Poppins-Light, Poppins" font-weight="300"><tspan x="0" y="0">Kabupaten Rembang</tspan></text>
                                    ...
                                    <h4 class="text-center mb-4">Silahkan Login</h4>
                                        ...
                                        @endif
                                    <form action="{{ route('post.login') }}" method="post" class="">
                                        @csrf
                                        <div class="mb-3">
