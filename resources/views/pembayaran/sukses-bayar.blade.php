...
<head>
   <meta charset="utf-8">
	...
	<!-- PAGE TITLE HERE -->
	<title>Sukses Bayar | E-SPTPD Kabupaten Rembang</title>
            ...
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-md-8">
                    <div class="form-input-content text-center error-page">
                        <h1 class="error-text text-success"><i class="fa-solid fa-money-bill"></i></h1>
                        <h4> Pembayaran Berhasil</h4>
                        <p>Selamat Pajak Anda Sudah Terbayarkan</p>
                        <div>
                            <a class="btn btn-primary" href="{{ route('wajib-pajak.tagihan') }}">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
