            ...
            <div class="row">
                <div class="col-lg-12">
						<div class="page-titles">
							<ol class="breadcrumb">
								<li class="breadcrumb-item "><a href="{{ route('admin.data-objek-pajak.pajak-parkir') }}">Data Pajak Parkiran</b></a></li>
                            ...
                            <div class="card">
                                <div class="card-header d-block">
                                    ...
                                    <div class="card-body pb-0">
                                        <form action="{{ route('admin.pajak-parkir.validasi-post',$objekpajak->id) }}" id="form" method="post">
                                            @csrf
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="btn-group d-flex col-xl-8" role="group" aria-label="section preference">
                                                            ...
                                                            <label class="btn btn-outline-success" for="option1">Diterima</label>   
                                                            
                                                            <input type="radio"  class="btn-check" name="validasi" value="Ditolak" id="option2" autocomplete="off"/>
                                                            <label class="btn btn-outline-danger" for="option2">Ditolak</label>
                                                            @error('validasi')
                                                    ...
                                                    <div class="card-footer border-0">
                                                        <div class="d-flex justify-content-star flex-wrap">
                                                            <button  href="javascript:void(0);" type="submit" class="btn btn-primary btn-sm me-2 sweet-confirm"><i class="far fa-check-circle me-2"></i>Simpan</button>
                                                        </div>
                                                    </div>
                                        </form>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-4">
                                    <div class="mb-3 d-flex justify-content-between">
                                        ...
                                        <span class="mx-2"> {{ $objekpajak->wajibpajak->nama }}</span>	
                                    </div>
                                    <div class="mb-3 d-flex justify-content-between">
                                        <h5 class="mb-1 fs-14 custom-label">NPWPD</h5>
                                        <span class="mx-3">{{ "P.".$objekpajak->wajibpajak->jenis_usaha.".".sprintf("%07s",$objekpajak->wajibpajak->no_pendaftaran).".".$objekpajak->wajibpajak->kecamatan->kode_kecamatan.".".$objekpajak->wajibpajak->kelurahan->kode_kelurahan }}</span>	
                                    </div>
                                    <div class="mb-3 d-flex justify-content-between">
                                        <h5 class="mb-1 fs-14 custom-label">Jenis Pendapatan</h5>
                                        <span class="mx-2">{{ $objekpajak->wajibpajak->jenis_pendapatan }}</span>	
                                    </div>
                                    <div class="mb-3 d-flex justify-content-between">
                                        <h5 class="mb-1 fs-14 custom-label">Jenis Usaha</h5>
                                        <span class="mx-2">{{ $objekpajak->wajibpajak->jenis_usaha == 1 ? 'Pribadi' : 'Badan Usaha' }}</span>	
                                    </div>
                                    <div class="mb-3 d-flex justify-content-between">
                                        <h5 class="mb-1 fs-14 custom-label">NIK</h5>
                                        <span class="mx-2">{{ $objekpajak->wajibpajak->nik }}</span>	
                                    </div>
                                    <div class="mb-3 d-flex justify-content-between">
                                        <h5 class="mb-1 fs-14 custom-label">Alamat</h5>
                                        <span class="mx-2">{{ $objekpajak->wajibpajak->alamat. ','.'RT'.' '.$objekpajak->wajibpajak->rt.','.'RW'.' '.$objekpajak->wajibpajak->rw. ','. ' '. $objekpajak->wajibpajak->kelurahan->nama_kelurahan. ',' . ' '.$objekpajak->wajibpajak->kecamatan->nama_kecamatan}}</span>	
                                    </div>
                                </div>
