...
@section('container')
                ...
                <div class="col-lg-12">
						<div class="page-titles">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><a>Data Pajak Restoran</a></li>
                 ...
                 <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Pajak restoran</h4>
                            </div>
                            <div class="card-body">
                                <!-- Nav tabs -->
                                <div class="custom-tab-1">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
                                            <a class="nav-link active text-primary" data-bs-toggle="tab" href="#home1"><i class=" fa-solid fa-ban me-2"></i> Pajak restoran Belum Tervalidasi</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link text-primary" data-bs-toggle="tab" href="#profile1"><i class="fa-solid fa-check me-2"></i> Pajak restoran Tervalidasi</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="table-responsive">
                                     <table id="pajak-restoran-belum-tervalidasi" class="display" style="min-width: 845px; width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Objek Pajak</th>
                                        ...
                                        <div class="tab-pane fade" id="profile1">
                                            <div class="pt-4">
                                                <div class="table-responsive">
                                                <table id="pajak-restoran-tervalidasi" class="display" style="min-width: 845px; width:100%" >
                                                    <thead>
                                                        <tr>
                                                            <th>No</th>
                                                            <th>Wajib Pajak</th>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal-restoran" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    $(document).ready(function () {
        $(document).on('click','.modal-restoran',function () {
            var stud_id = $(this).val();
            // alert(stud_id)
            $('#modal-restoran').modal('show')
            $.ajax({
                type:"GET",
                url:"pajak-restoran/show/" +stud_id,
	...
	// Pajak Restoran Belum Tervalidasi
    $(document).ready(function (){
        $('#pajak-restoran-belum-tervalidasi').DataTable({
        ordering:true,
        processing: true,
        serverSide:true,
        ajax:"/admin/data-objek-pajak/pajak-restoran/dataTableRestoranBelumValidasiJson",
        // ajax:"{{ route('admin.datatable-restoran-belum-validasi') }}",
        columns: [
            ...
            {data: 'id_jenis_pajak',name:'id_jenis_pajak',class: "text-center"},
            {data: 'id_wajib_pajak',name:'id_wajib_pajak',class: "text-center"},
            {data: 'tanggal_daftar_objek',name:'tanggal_daftar_objek',class: "text-center"},
    ...
    // Pajak Restoran  Tervalidasi
        $('#pajak-restoran-tervalidasi').DataTable({
        ordering:true,
        processing: true,
        serverSide:true,
        ajax:"/admin/data-objek-pajak/pajak-restoran/dataTableRestoranTerValidasiJson",
        // ajax:"{{ route('admin.datatable-restoran-tervalidasi') }}",
        columns: [
            {data: 'DT_RowIndex',name:'DT_RowIndex',width:'10px',class:'text-center',orderable:false,searchable:false},
            {data: 'id_wajib_pajak',name:'id_wajib_pajak',class: "text-center"},
