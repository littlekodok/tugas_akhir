            ...
            <div class="row">
                <div class="col-lg-12">
						<div class="page-titles">
							<ol class="breadcrumb">
								<li class="breadcrumb-item "><a href="{{ route('admin.data-objek-pajak.pajak-hotel') }}">Data Pajak Hotel</b></a></li>
                            ...
                            <div class="card">
                                <div class="card-header d-block">
                                    ...
                                    <div class="card-body pb-0">
                                        <form action="{{ route('admin.pajak-hotel.validasi-post',$objekpajak->id) }}" id="form" method="post">
                                            @csrf
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-4">
                                    <div class="mb-3 d-flex justify-content-between">
                                        ...
                                        <span class="text-capitalize"> {{ $objekpajak->wajibpajak->nama }}</span>	
                                    </div>
                                    <div class="mb-3 d-flex justify-content-between">
                                    ...
                                    <div class="mb-3 d-flex justify-content-between">
                                        ...
                                        <span>{{ $objekpajak->wajibpajak->jenis_pendapatan }}</span>	
                                    </div>
                                    <div class="mb-3 d-flex justify-content-between">
                                    ...
                                    <div class="mb-3 d-flex justify-content-between">
                                        ...
                                        <p>{{ $objekpajak->wajibpajak->alamat. ',' .' '.'RT'.' '.$objekpajak->wajibpajak->rt.','.' '.'RW'.' '.$objekpajak->wajibpajak->rw. ','. ' '. $objekpajak->wajibpajak->kelurahan->nama_kelurahan. ',' . ' '.$objekpajak->wajibpajak->kecamatan->nama_kecamatan}}</p>	
                                    </div>
                                </div>
