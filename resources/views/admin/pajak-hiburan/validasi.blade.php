            ...
            <div class="row">
                <div class="col-lg-12">
						<div class="page-titles">
							<ol class="breadcrumb">
								<li class="breadcrumb-item "><a href="{{ route('admin.data-objek-pajak.pajak-hiburan') }}">Data Pajak Hiburan</b></a></li>
                            ...
                            <div class="card">
                                <div class="card-header d-block">
                                    ...
                                    <div class="card-body pb-0">
                                        <form action="{{ route('admin.pajak-hiburan.validasi-post',$objekpajak->id) }}" id="form" method="post">
                                            @csrf
